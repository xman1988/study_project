...
// 		// public $show3 = array_pop($counterData[2][0]);
// 		// public $show4 = array_pop($counterData[3][0]);

// 		public function showStats($result){
// 			var_dump($result);
// 			// echo "<br>Количество всех хитов: &nbsp".$this->show1.
// 			//      "<br>Количество хитов клиента: &nbsp".$this->show2.   
// 			//      "<br>Количество моих хитов: &nbsp".$this->show3.
// 			//      "<br>Количество хостов: &nbsp".$this->show4.   
// 			// 	 "<br><br>
